...
required_paths=(
  "${publish_paths[@]}"
  "api/teklif.php"
  "css/hero-animated.css" "css/services-tune.css" "css/section-03.css"
  "partials/section-03-about.inc"
  "js/hero-animated.js" "js/quote-form.js"
...
required_output_files=(
  ...
  "css/style.css" "css/hero-animated.css" "css/services-tune.css" "css/section-03.css"
  "partials/section-03-about.inc"
  "js/script.js" "js/hero-animated.js" "js/quote-form.js"
  "hizmetler/paketleme-montaj.html"
  "assets/images/about-canpolat-approved.webp"
  "assets/images/service-evden-eve.webp" "assets/images/service-sehirler-arasi.webp"
  "assets/images/service-ofis.webp" "assets/images/service-asansorlu.webp" "assets/images/service-paketleme.webp"

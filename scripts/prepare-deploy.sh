...
required_paths=(
  "${publish_paths[@]}"
  "api/teklif.php"
  "css/hero-animated.css" "css/services-tune.css" "css/section-03.css" "css/section-04.css"
...
required_output_files=(
  ...
  "css/style.css" "css/hero-animated.css" "css/services-tune.css" "css/section-03.css" "css/section-04.css"
  "partials/section-03-about.inc" "partials/section-04-process.inc"

...
| `hero-canpolat.png` | Hero bölümü (kamyon görseli) | 900 × 620 px (şeffaf PNG) |
...
- **Hero görseli:** `assets/images/hero-canpolat.png`. Yükseklik/oran: `css/style.css` → `.hero__image`.
...
- **Performans:** Hero görseli `preload` + `fetchpriority="high"`, diğer görseller `loading="lazy"`,
